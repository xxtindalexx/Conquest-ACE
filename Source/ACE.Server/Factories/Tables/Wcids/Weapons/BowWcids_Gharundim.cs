...
namespace ACE.Server.Factories.Tables.Wcids
{
    public static class BowWcids_Gharundim
    {
        ...
        private static ChanceTable<WeenieClassName> T5_Chances = new ChanceTable<WeenieClassName>()
        {
            ...
            ( WeenieClassName.yag,                          0.11f ),
            ( WeenieClassName.nayin,                        0.11f ),
            ...
            ( WeenieClassName.conquest_netheryag,           0.03f ),
            ( WeenieClassName.conquest_nethernayin,         0.03f ),
        };
        ...
        private static ChanceTable<WeenieClassName> T6_T8_Chances = new ChanceTable<WeenieClassName>()
        {
            ...
            ( WeenieClassName.conquest_netheryag,           0.07f ),
            ( WeenieClassName.conquest_nethernayin,         0.07f ),
        };
