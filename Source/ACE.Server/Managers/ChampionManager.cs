...
namespace ACE.Server.Managers
{
    ...
    public static class ChampionManager
    {
        ...
        public static int GetTierForWcid(uint wcid)
        {
            ...
            var deathTreasureType = weenie.GetProperty(PropertyDataId.DeathTreasureType);
            if (!deathTreasureType.HasValue)
                return 0;

            var treasureDeath = DatabaseManager.World.GetCachedDeathTreasure(deathTreasureType.Value);
            if (treasureDeath == null)
                return 0;
