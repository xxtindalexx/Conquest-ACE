    ...
    public class CreatureAttribute
    {
        ...
        public uint Base
        {
            get
            {
                ...
                // CONQUEST: Enlightenment stat bonus is added directly to StartingValue in Enlightenment.cs
                // This ensures the client displays it correctly on the character panel
