    ...
    partial class Player
    {
        ...
        public void DepositConquestCoins(bool suppressChat = false)
        {
            ...
            lock (balanceLock)
            {
                long totalDeposited = 0;
                //int i = 0;
                var coinList = this.GetInventoryItemsOfWCID(300004); // TODO: Update WCID for Conquest Coins
        ...
        public void DepositSoulFragments(bool suppressChat = false)
        {
            ...
            lock (balanceLock)
            {
                long totalDeposited = 0;
                //int i = 0;
                var fragmentList = this.GetInventoryItemsOfWCID(300003); // TODO: Update WCID for Soul Fragments
