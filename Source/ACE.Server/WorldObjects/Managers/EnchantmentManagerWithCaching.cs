...
namespace ACE.Server.WorldObjects.Managers
{
    public class EnchantmentManagerWithCaching : EnchantmentManager
    {
        ...
        /// </summary>
        public override AddEnchantmentResult Add(Spell spell, WorldObject caster, WorldObject weapon, bool equip = false, bool fromProc = false)
        {
            var result = base.Add(spell, caster, weapon, equip, fromProc);
