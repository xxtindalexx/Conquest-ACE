...
{
    /// <summary>
    /// CONQUEST: Landblocks where player corpses drop no items on death
    /// </summary>
    public static class NoDropLandblocks
    {
        private const string PropertyName = "nodrop_landblocks";
        ...
        /// <summary>
        /// CONQUEST: Returns true if corpses on this landblock + variant drop no items
        /// </summary>
